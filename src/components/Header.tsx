    ...
    <>
      ...
      <header className="home-nav-header">
        ...
        <div className="home-nav-cta">
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSfTb-CX5O1emu3Nnl-by9FRGVlEOTIwyZBoVxsm2t46eZdbFg/viewform" target="_blank" rel="noopener noreferrer" className="home-join-btn hidden md:block">Join Us</a>
